...
//             className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-purple px-6 py-3 rounded-lg flex items-center gap-2 transition-all duration-200 transform hover:scale-105"
//           >
//             <Plus size={20} />
//             New Connection
//           </button>
...
//             <button
//               onClick={() => handleOpenModal()}
//               className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-purple px-6 py-3 rounded-lg inline-flex items-center gap-2"
//             >
//               <Plus size={20} />
//               New Connection
//             </button>
...
//                   <Link size={20} className="text-purple" />
//                 </div>
//                 <div>
...
//               <button
//                 onClick={handleCloseModal}
//                 className="text-green-200 hover:text-purple p-2 rounded-md"
//                 aria-label="Close"
//               >
//                 ✕
//               </button>
...
//                     }))
//                   }
//                   className="w-full bg-slate-800 text-purple rounded-md p-2 border border-white/10"
//                   required
//                   aria-required
//                 >
...
//                 <button
//                   type="submit"
//                   className="px-4 py-2 rounded-md bg-gradient-to-r from-green-500 to-emerald-500 text-purple hover:scale-[1.02] transition-transform"
//                 >
...
//           <button
//             onClick={() => handleOpenModal()}
//             className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-purple px-6 py-3 rounded-lg flex items-center gap-2 transition-all duration-200 transform hover:scale-105 shadow-lg shadow-purple-500/20"
//           >
//             <Plus size={20} />
//             New Connection
//           </button>
...
//             <div
//               key={connection.id}
//               className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-purple-400/20 hover:border-purple-400/50 transition-all duration-300 group shadow-lg shadow-purple-500/10"
//             >
//               <div className="flex items-center justify-between">
//                 <div className="flex items-center gap-6 flex-1">
//                   {/* Source */}
...
//                           getSourceName(connection.sourceId)}
//                       </h3>
//                       <p className="text-purple-300 text-sm">Source</p>
//                     </div>
//                   </div>
...
//                           getDestinationName(connection.destinationId)}
//                       </h3>
//                       <p className="text-purple-300 text-sm">Destination</p>
//                     </div>
//                   </div>
//                 </div>
...
//             <button
//               onClick={() => handleOpenModal()}
//               className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-purple px-6 py-3 rounded-lg inline-flex items-center gap-2 shadow-lg shadow-purple-500/20"
//             >
//               <Plus size={20} />
//               New Connection
//             </button>
...
//             aria-hidden
//           />
//           <div className="relative w-full max-w-lg bg-gradient-to-br from-purple-900 to-indigo-900 rounded-2xl p-6 border border-purple-400/20 shadow-xl shadow-purple-500/20 z-10">
//             <div className="flex items-center justify-between mb-4">
//               <div className="flex items-center gap-3">
//                 <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-indigo-500 rounded-lg flex items-center justify-center shadow-md">
//                   <Link size={20} className="text-purple" />
...
//               <button
//                 onClick={handleCloseModal}
//                 className="text-purple-300 hover:text-purple p-2 rounded-md transition-colors"
//                 aria-label="Close"
//               >
//                 ✕
//               </button>
...
//                     }))
//                   }
//                   className="w-full bg-purple-900/50 text-purple rounded-md p-2 border border-purple-400/20 focus:border-purple-400 focus:outline-none focus:ring-1 focus:ring-purple-500"
//                   required
//                   aria-required
//                 >
//                   <option value="">Select a source</option>
...
//                   type="button"
//                   onClick={handleCloseModal}
//                   className="px-4 py-2 rounded-md bg-purple-800/50 text-purple-300 hover:bg-purple-800 transition-colors border border-purple-400/20"
//                 >
//                   Cancel
//                 </button>
//                 <button
//                   type="submit"
//                   className="px-4 py-2 rounded-md bg-gradient-to-r from-purple-600 to-indigo-600 text-purple hover:from-purple-700 hover:to-indigo-700 transition-all transform hover:scale-[1.02] shadow-md shadow-purple-500/20"
//                 >
//                   {editingConnection ? 'Save Changes' : 'Create Connection'}
//                 </button>
//               </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6">
          {connections?.map((connection) => (
            <div
              key={connection.id}
              className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-purple-400/50 transition-all duration-300 group shadow-md shadow-purple-500/10"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6 flex-1">
                  {/* Source */}
